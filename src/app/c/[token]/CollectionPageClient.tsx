        ...
        <div className="p-6 space-y-4">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3 pr-6">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary shadow-sm shadow-primary/10 ring-1 ring-primary/10">
          ...
          {/* Image preview */}
          {isImage && (
            <div className="flex justify-center items-center rounded-xl overflow-hidden bg-muted/40 border min-h-[140px]">
              {previewError ? (
          ...
          {/* File meta stats */}
          <div className="grid grid-cols-3 divide-x rounded-xl border bg-muted/10 text-center">
            <div className="px-3 py-2.5">
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-medium">
                Type
              </p>
              <p className="text-sm font-bold mt-0.5">{category}</p>
            </div>
            <div className="px-3 py-2.5">
              <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-medium">
                Size
          ...
          <Button
            ...
            className="w-full gap-2 btn-shimmer text-white shadow-md shadow-primary/20"
            size="lg"
          >
            {downloading ? (
  ...
  return (
    <div className="w-full max-w-2xl space-y-4">
      ...
      <div className="rounded-2xl border bg-card shadow-lg shadow-black/5 overflow-hidden">
        {/* Top gradient bar — matches share page */}
        <div className="h-1 w-full bg-gradient-to-r from-primary/40 via-primary to-violet-500/60" />
        ...
        <div className="px-6 py-5">
          ...
          {/* Stats row — matches share page style */}
          <div className="mt-5 grid grid-cols-3 divide-x border rounded-xl bg-muted/10">
            ...
            <div className="flex flex-col items-center gap-0.5 px-4 py-3.5">
              ...
              <span className="text-lg font-bold">{activeFiles.length}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-card shadow-lg shadow-black/5 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3 border-b bg-muted/10">
          <p className="text-sm font-semibold">Files in this share</p>
          <Button
            variant="outline"
            size="sm"
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                      <span className="inline-flex items-center rounded-full bg-primary/8 px-1.5 py-0.5 text-[10px] font-medium text-primary">
                        {category}
                      </span>
                  ...
                  {file.is_expired ? (
                    ...
                    <Button
                      size="sm"
                      className="gap-1.5 shrink-0 h-8 btn-shimmer text-white shadow-sm shadow-primary/20"
      ...
      {/* Footer — matches share page */}
      <p className="text-center text-xs text-muted-foreground">
        🔒 Files are securely stored and will expire as shown above. Shared via{" "}
